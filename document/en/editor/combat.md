...
- When set on the opponent's side (the Action's combat value and the opponent's skills), it works in reverse, and the player's restoration amount decreases by that value instead.