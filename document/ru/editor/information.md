...
# информация
Конфигурация основной информации об элементе (ID, имя, значок, цвет и т. д.).
- Основные элементы информации, общие для каждого элемента в мире (категории, действия, предметы, события и т.д.).
- Каждый элемент конфигурируется отдельно.
___
