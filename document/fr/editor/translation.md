...
- Exemple d'instruction : traduisez de l'anglais vers le japonais les valeurs de `name` et `explanation` des données JSON téléversées. Ne modifiez aucune autre partie.
___
