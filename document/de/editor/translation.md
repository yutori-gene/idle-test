...
- Beispiel für eine Eingabeaufforderung: Übersetze die Werte von `name` und `explanation` in den hochgeladenen JSON-Daten aus dem Englischen ins Japanische. Ändere keine anderen Teile.
___
