...
`;console.log(`🎮 Player Build Version: 0.0.1689`),console.log(`📅 Player Build Date: ${new Date(`2026-08-23T07:30:43.619Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(kt,{})}));