...
`;console.log(`🎮 Player Build Version: 0.0.1510`),console.log(`📅 Player Build Date: ${new Date(`2026-08-02T04:24:49.104Z`).toLocaleString(`ja-JP`)}`),be.createRoot(document.getElementById(`root`)).render((0,X.jsx)(W.StrictMode,{children:(0,X.jsx)(pt,{})}));