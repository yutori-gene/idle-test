...
`;function st(){let[t,n]=k.hooks.useConfirm(e=>{e||(k.viewport.normalize(),window.location.hash=``,requestAnimationFrame(()=>window.location.reload()))});return r(T,{children:[W(`span`,{css:e.gapBottom,children:W(F,{title:[`preset`,`updated`],explanation:[`text`,L.primitive.toDateTimeText(`2026-08-20T11:53:16.683Z`)]})}),W(_,{id:`restart`,event:[`click`,()=>n(),t]})]})}function ct(){let e=R.check.debugMode(),r=k.hooks.usePath(0),s=V(r),l=k.component.sortGroup(R.check.visibleList(a(!0).categories),e=>e.world.group),u=R.trade.getQueueSummary(),d=R.trade.getCapacitySummary(),f=R.check.visibleList(c),m=I.event.getAchievedSummary(f),h=I.property.getStatusSummary();return(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsxs)(D,{path:r,background:`world`,children:[(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(t,{}),(0,Y.jsx)(H,{base:s.information,path:r,color:s.information.color})]}),(0,Y.jsx)(Y.Fragment,{children:(0,Y.jsxs)(o,{text:`character`,path:r,children:[(0,Y.jsx)(p,{href:`/activity.character`,children:(0,Y.jsx)(F,{title:[`preset`,`activity`],explanation:[`text`,u.text],flagColor:u.flag})}),(0,Y.jsx)(p,{href:`/inventory.character`,children:(0,Y.jsx)(F,{title:[`preset`,`inventory`],explanation:[`text`,d.text],flagColor:d.flag})}),(0,Y.jsx)(p,{href:`/status.character`,children:(0,Y.jsx)(F,{title:[`preset`,`status`],explanation:[`text`,h.text],flagColor:h.flag})}),f.length>0&&(0,Y.jsx)(p,{href:`/missions.character`,children:(0,Y.jsx)(F,{title:[`preset`,`missions`],explanation:[`text`,m.text],flagColor:m.flag})})]})}),(0,Y.jsx)(Y.Fragment,{children:l.map(e=>(0,Y.jsx)(i,{categories:e,path:r},e[0].world.group))}),(0,Y.jsx)(Y.Fragment,{children:(0,Y.jsxs)(o,{text:`world`,path:r,children:[(0,Y.jsx)(p,{href:`/overview.world`,children:(0,Y.jsx)(F,{title:[`preset`,`overview`]})}),(0,Y.jsx)(p,{href:`/statistics.world`,children:(0,Y.jsx)(F,{title:[`preset`,`statistics`]})}),(0,Y.jsx)(p,{href:`/config.world`,children:(0,Y.jsx)(F,{title:[`preset`,`config`]})}),e&&(0,Y.jsx)(p,{href:`/debug.world`,children:(0,Y.jsx)(F,{title:[`preset`,`debug`]})})]})})]}),(0,Y.jsxs)(g,{children:[(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(n,{path:`/activity.character/*?`,children:(0,Y.jsx)(He,{})}),(0,Y.jsx)(n,{path:`/inventory.character/*?`,children:(0,Y.jsx)(We,{})}),(0,Y.jsx)(n,{path:`/status.character/*?`,children:(0,Y.jsx)(Ge,{})}),(0,Y.jsx)(n,{path:`/missions.character/*?`,children:(0,Y.jsx)(Ve,{})})]}),(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(n,{path:`/overview.world/*?`,children:(0,Y.jsx)(Re,{})}),(0,Y.jsx)(n,{path:`/statistics.world/*?`,children:(0,Y.jsx)(ze,{})}),(0,Y.jsx)(n,{path:`/config.world/*?`,children:(0,Y.jsx)(Ke,{})}),(0,Y.jsx)(n,{path:`/debug.world/*?`,children:(0,Y.jsx)(tt,{})})]}),k.hooks.useDefaultRoutes(r)]})]})}function lt({children:e}){let t=ut();return W(`span`,{id:`grider`,css:[t.base,t.scrollbarStyle],children:e})}function ut(){return{base:u`
		...
		`}}var dt={duration:300,snappingDown:!0};function ft(){let e=(0,G.useRef)(null),t=k.hooks.useSmoothRef(()=>{let e=I.progress.getSingletonProgressing();return e?te(U(e.general.id).categoryId).user.level%1:0},dt);return k.hooks.useUpdate(()=>{let n=e.current;if(!n)return;let r=I.progress.getSingletonProgressing(),i=L.primitive.clamp(t.current,0,1);n.style.setProperty(`--header-percentage`,`${i*100}%`),n.style.setProperty(`--header-color`,r?k.style.geFadedColor(U(r.general.id).information.color):`transparent`)}),W(`div`,{css:pt(),ref:e})}function pt(){return u`
		position: fixed;
		...
		z-index: 20;
	`}var mt={},ht={duration:300};function gt(){let[e,t]=(0,G.useState)(()=>k.scroll.getScrolledPosition().x>0),[n,i]=(0,G.useState)(()=>I.progress.getSingletonProgressing()?.general.id),a=(0,G.useRef)(null),[,o]=k.hooks.useLocation(),s=()=>{k.scroll.slideTop()},c=()=>{let e=k.component.getSingletonProgressingPath();e&&(o(e),k.scroll.slideBottom())},u=k.hooks.useSmoothRef(()=>{let e=I.progress.getSingletonProgressing();return e?I.progress.caluculateBarProgresing(e):0},()=>I.progress.getSingletonProgressing()?.combat?ht:mt);return k.hooks.useUpdate(()=>{i(I.progress.getSingletonProgressing()?.general.id),t(k.scroll.getScrolledPosition().x>0);let e=a.current;e&&(e.style.transform=`scaleX(${L.primitive.clamp(u.current,0,1)})`)}),r(`span`,{css:[_t(8).base],children:[W(l,{height:8,fillRef:a,color:n?k.style.getActionProgressColor(n):void 0}),e&&W(b,{id:`go-top`,leftern:!0,handler:s,size:26}),n&&W(b,{id:n,leftern:!1,handler:c,size:26})]})}function _t(e){return{base:u`
			/* display: flex; */
			position: relative;
			width: 100svw;
			height: ${e}px;
		...
		`}}var vt,yt,bt=2/3,xt=.15;function St(){let[e]=k.hooks.useLocation();return vt?null:(k.component.setBackgroundHandler(Ct),Ct(wt(e)),null)}function Ct(t){if(Tt(vt,t))return;vt=t;let n=(t==`world`?``:te(t[1]).world.background)||N.basic.design.background||``;if(yt===n)return;yt=n;let r=e.colors.background,{h:i,s:a,l:o}=M(r).hsl().object(),s=Et(i*(1-xt),a*(1-xt),o*(1-xt)),c=Et(i*1.15,a*1.15,o*1.15),l=e=>`linear-gradient(
		to top,
		${M(s).alpha(e).rgb().string()},
		${M(r).alpha(e).rgb().string()},
		${M(c).alpha(e).rgb().string()}
	)`;window.document.body.style.background=n?`${l(bt)}, url(${n}) center / cover no-repeat fixed`:l(1),window.document.body.style.backgroundColor=e.colors.bar}function wt(e){let t=e.split(`/`).reverse();for(let e of t){let[t,n]=e.split(`.`);if(!(!t||!n)){if(n==`category`)return[`category`,t];if(n==`action`)return[`category`,U(t).categoryId];if(n==`item`){let e=w(t).categoryId;return e?[`category`,e]:`world`}}}return`world`}function Tt(e,t){return e?e==`world`?t==`world`:t==`world`?!1:e[1]==t[1]:!1}function Et(e,t,n){return`hsl(${e}, ${t}%, ${n}%)`}function Dt(){let[e,t]=(0,G.useState)(!1),n=(0,G.useRef)(!1);(0,G.useEffect)(()=>{(async()=>{if(!n.current){n.current=!0;try{await ne(),be(),re(),I.event.check(),t(!0)}catch(e){console.error(`Initialization error:`,e)}}})()},[]);let[i,a]=k.hooks.useLocation();(0,G.useEffect)(()=>{if(!e)return;let t=me(i);t&&a(t)},[e,i,a]),(0,G.useEffect)(()=>{e&&(_e(),ie())},[e]);let o=()=>{if(R.check.debugMode())return{background:`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`,color:`white`};let e=document.querySelector(`meta[name="bar-color"]`),t=document.querySelector(`meta[name="text-color"]`);return{background:e?.content||`#667eea`,color:t?.content||`white`}};if(!e){let e=o();return r(`div`,{css:on(e.background,e.color),children:[W(Le,{color:e.color,size:80,cssOverride:{display:`block`}}),W(`h2`,{children:`Loading Game...`}),W(`p`,{children:`Initializing world data and assets`})]})}return W(ye,{children:W(Ot,{})})}function Ot(){return pe(),r(S,{children:[W(`div`,{style:{display:de?`block`:`none`},children:`This game was interrupted because it was opened in another tab.`}),r(`div`,{style:{display:de?`none`:`block`},children:[W(x,{styles:rn}),W(ue,{base:`/`,hook:ke,children:r(`div`,{css:an,children:[W(ft,{}),W(lt,{children:W(ct,{})}),W(gt,{})]})}),W(kt,{}),W(fe,{}),W(St,{})]})]})}function kt(){let{toasts:e,handlers:t}=ee(Jt),n=new Map(At.map(e=>[e,[]]));for(let t of e)n.get(t.position||Ft).push(t);let r=n.get(`bottom-left`).length>0||n.get(`bottom-right`).length>0;return W(`div`,{className:Pt,style:It,children:[...n].filter(([,e])=>e.length>0).map(([e,n])=>W(`div`,{style:Vt(e,r&&e==`bottom-center`),children:jt(e,n).map(n=>W(Mt,{item:n,position:e,onHeightUpdate:t.updateHeight},n.id))},e))})}var At=[`top-left`,`top-center`,`top-right`,`bottom-left`,`bottom-center`,`bottom-right`];function jt(e,t){if(e.startsWith(`top`))return t;let n=[...t].reverse();if(e!=`bottom-left`&&e!=`bottom-right`)return n;let r=e=>e.className==k.toaster.cornerPopClassName?0:1;return n.sort((e,t)=>r(e)-r(t))}function Mt({item:e,position:t,onHeightUpdate:n}){return W(`div`,{ref:(0,G.useCallback)(t=>{t&&n(e.id,t.getBoundingClientRect().height)},[e.id,n]),style:e.className==k.toaster.inlineClassName?Rt:zt(t),children:W(d,{toast:e,style:tn(e)})})}var Z={fontSize:`12px`,padding:`5px 7px`},Nt=5,Pt=`playerToaster`,Ft=`top-center`,Q=16,It={position:`fixed`,zIndex:9999,top:Q,left:Q,right:Q,bottom:Q,pointerEvents:`none`},Lt=100,Rt={display:`flex`};function zt(e){return{display:`flex`,flexBasis:`100%`,justifyContent:Bt(e)}}function Bt(e){return e.endsWith(`left`)?`flex-start`:e.endsWith(`right`)?`flex-end`:`center`}function Vt(e,t){return{position:`absolute`,left:0,right:0,...e.startsWith(`top`)?{top:0}:{bottom:0},display:`flex`,flexFlow:`row wrap`,alignItems:`center`,justifyContent:Bt(e),gap:`${Nt}px`,...t?{paddingLeft:`${Lt}px`,paddingRight:`${Lt}px`}:{}}}var Ht=`playerToastFadeIn`,Ut=`playerToastFadeOut`,Wt=`playerToastPopInTop`,Gt=`playerToastPopInBottom`,Kt=`playerToastPopOutBottom`,qt=300,$=`${qt}ms`,Jt={removeDelay:qt},Yt=3e3,Xt={...Z,pointerEvents:`auto`,animation:`${Ht} ${$} ease-in-out forwards`},Zt={...Z,pointerEvents:`none`,animation:`${Ut} ${$} ease-in-out forwards`},Qt={...Z,pointerEvents:`auto`,animation:`${Wt} ${$} ease-in-out forwards`},$t={...Z,pointerEvents:`auto`,animation:`${Gt} ${$} ease-in-out forwards`},en={...Z,pointerEvents:`none`,animation:`${Kt} ${$} ease-in-out forwards`};function tn(e){let t=nn(e);return e.position==`bottom-left`||e.position==`bottom-right`?{...t,pointerEvents:`none`}:t}function nn(e){return e.position==`bottom-left`||e.position==`bottom-right`?e.visible?$t:en:e.visible?(e.duration??0)<Yt?Xt:(e.position??`top-center`).startsWith(`top`)?Qt:$t:Zt}var rn=u`
	...
	.${Pt} > div > div > div > div:last-child {
		margin: 3px 7px;
	}

	/* 本文以外の子＝showResult の成功/失敗アイコン。ライブラリ内で 20px 固定なので、
	   他のアイコンに合わせて縮小する */
	.${Pt} > div > div > div > div:not(:last-child) {
...
`;console.log(`🎮 Player Build Version: 0.0.1673`),console.log(`📅 Player Build Date: ${new Date(`2026-08-20T11:53:16.683Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Dt,{})}));