...
`;console.log(`🎮 Player Build Version: 0.0.1694`),console.log(`📅 Player Build Date: ${new Date(`2026-08-23T08:20:29.843Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(At,{})}));