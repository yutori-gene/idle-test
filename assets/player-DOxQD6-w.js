...
`;console.log(`🎮 Player Build Version: 0.0.1529`),console.log(`📅 Player Build Date: ${new Date(`2026-08-08T11:36:27.871Z`).toLocaleString(`ja-JP`)}`),Se.createRoot(document.getElementById(`root`)).render((0,q.jsx)(H.StrictMode,{children:(0,q.jsx)(bt,{})}));