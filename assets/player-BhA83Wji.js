...
`;console.log(`🎮 Player Build Version: 0.0.1750`),console.log(`📅 Player Build Date: ${new Date(`2026-08-28T13:08:08.960Z`).toLocaleString(`ja-JP`)}`),Oe.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(W.StrictMode,{children:(0,Y.jsx)(Nt,{})}));