...
`;console.log(`🎮 Player Build Version: 0.0.1647`),console.log(`📅 Player Build Date: ${new Date(`2026-08-15T01:50:07.178Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Ct,{})}));