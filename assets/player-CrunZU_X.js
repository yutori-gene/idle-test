...
`;console.log(`🎮 Player Build Version: 0.0.1608`),console.log(`📅 Player Build Date: ${new Date(`2026-08-13T11:00:32.594Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));