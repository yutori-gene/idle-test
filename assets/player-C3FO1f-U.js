...
`;console.log(`🎮 Player Build Version: 0.0.1684`),console.log(`📅 Player Build Date: ${new Date(`2026-08-22T06:38:53.595Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(kt,{})}));