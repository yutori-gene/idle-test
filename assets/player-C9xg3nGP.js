...
`;console.log(`🎮 Player Build Version: 0.0.1647`),console.log(`📅 Player Build Date: ${new Date(`2026-08-15T05:26:33.554Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));