...
`;console.log(`🎮 Player Build Version: 0.0.1612`),console.log(`📅 Player Build Date: ${new Date(`2026-08-13T12:35:41.359Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));