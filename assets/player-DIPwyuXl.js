...
`;console.log(`🎮 Player Build Version: 0.0.1532`),console.log(`📅 Player Build Date: ${new Date(`2026-08-09T06:01:40.668Z`).toLocaleString(`ja-JP`)}`),Se.createRoot(document.getElementById(`root`)).render((0,q.jsx)(H.StrictMode,{children:(0,q.jsx)(bt,{})}));