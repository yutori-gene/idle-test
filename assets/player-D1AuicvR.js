...
`;console.log(`🎮 Player Build Version: 0.0.1694`),console.log(`📅 Player Build Date: ${new Date(`2026-08-23T06:07:36.181Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(At,{})}));