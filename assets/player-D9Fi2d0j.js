...
`;console.log(`🎮 Player Build Version: 0.0.1616`),console.log(`📅 Player Build Date: ${new Date(`2026-08-14T05:33:53.711Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));