...
`;console.log(`🎮 Player Build Version: 0.0.1671`),console.log(`📅 Player Build Date: ${new Date(`2026-08-19T03:50:52.650Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));