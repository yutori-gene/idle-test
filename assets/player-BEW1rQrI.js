...
`;console.log(`🎮 Player Build Version: 0.0.1669`),console.log(`📅 Player Build Date: ${new Date(`2026-08-16T15:10:14.364Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));