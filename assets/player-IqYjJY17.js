...
`;console.log(`🎮 Player Build Version: 0.0.1519`),console.log(`📅 Player Build Date: ${new Date(`2026-08-04T11:45:49.483Z`).toLocaleString(`ja-JP`)}`),ve.createRoot(document.getElementById(`root`)).render((0,Z.jsx)(K.StrictMode,{children:(0,Z.jsx)(ft,{})}));