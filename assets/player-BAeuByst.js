...
`;console.log(`🎮 Player Build Version: 0.0.1519`),console.log(`📅 Player Build Date: ${new Date(`2026-08-05T09:03:25.968Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(U.StrictMode,{children:(0,Y.jsx)(vt,{})}));