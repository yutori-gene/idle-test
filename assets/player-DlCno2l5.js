...
`;console.log(`🎮 Player Build Version: 0.0.1673`),console.log(`📅 Player Build Date: ${new Date(`2026-08-19T12:03:20.561Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));