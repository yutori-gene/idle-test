...
`;console.log(`🎮 Player Build Version: 0.0.1598`),console.log(`📅 Player Build Date: ${new Date(`2026-08-13T09:46:41.810Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));