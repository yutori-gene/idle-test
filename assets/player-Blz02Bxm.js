...
`;console.log(`🎮 Player Build Version: 0.0.1588`),console.log(`📅 Player Build Date: ${new Date(`2026-08-12T12:26:02.213Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));