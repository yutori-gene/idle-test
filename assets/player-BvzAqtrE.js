...
`;function ct(){let[t,n]=O.hooks.useConfirm(e=>{e||(O.viewport.normalize(),window.location.hash=``,requestAnimationFrame(()=>window.location.reload()))});return r(T,{children:[W(`span`,{css:e.gapBottom,children:W(F,{title:[`preset`,`updated`],explanation:[`text`,L.primitive.toDateTimeText(`2026-08-20T12:22:31.620Z`)]})}),W(_,{id:`restart`,event:[`click`,()=>n(),t]})]})}function lt(){let e=R.check.debugMode(),r=O.hooks.usePath(0),s=V(r),l=O.component.sortGroup(R.check.visibleList(a(!0).categories),e=>e.world.group),u=R.trade.getQueueSummary(),d=R.trade.getCapacitySummary(),f=R.check.visibleList(c),m=I.event.getAchievedSummary(f),h=I.property.getStatusSummary();return(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsxs)(E,{path:r,background:`world`,children:[(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(t,{}),(0,Y.jsx)(H,{base:s.information,path:r,color:s.information.color})]}),(0,Y.jsx)(Y.Fragment,{children:(0,Y.jsxs)(o,{text:`character`,path:r,children:[(0,Y.jsx)(p,{href:`/activity.character`,children:(0,Y.jsx)(F,{title:[`preset`,`activity`],explanation:[`text`,u.text],flagColor:u.flag})}),(0,Y.jsx)(p,{href:`/inventory.character`,children:(0,Y.jsx)(F,{title:[`preset`,`inventory`],explanation:[`text`,d.text],flagColor:d.flag})}),(0,Y.jsx)(p,{href:`/status.character`,children:(0,Y.jsx)(F,{title:[`preset`,`status`],explanation:[`text`,h.text],flagColor:h.flag})}),f.length>0&&(0,Y.jsx)(p,{href:`/missions.character`,children:(0,Y.jsx)(F,{title:[`preset`,`missions`],explanation:[`text`,m.text],flagColor:m.flag})})]})}),(0,Y.jsx)(Y.Fragment,{children:l.map(e=>(0,Y.jsx)(i,{categories:e,path:r},e[0].world.group))}),(0,Y.jsx)(Y.Fragment,{children:(0,Y.jsxs)(o,{text:`world`,path:r,children:[(0,Y.jsx)(p,{href:`/overview.world`,children:(0,Y.jsx)(F,{title:[`preset`,`overview`]})}),(0,Y.jsx)(p,{href:`/statistics.world`,children:(0,Y.jsx)(F,{title:[`preset`,`statistics`]})}),(0,Y.jsx)(p,{href:`/config.world`,children:(0,Y.jsx)(F,{title:[`preset`,`config`]})}),e&&(0,Y.jsx)(p,{href:`/debug.world`,children:(0,Y.jsx)(F,{title:[`preset`,`debug`]})})]})})]}),(0,Y.jsxs)(g,{children:[(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(n,{path:`/activity.character/*?`,children:(0,Y.jsx)(He,{})}),(0,Y.jsx)(n,{path:`/inventory.character/*?`,children:(0,Y.jsx)(We,{})}),(0,Y.jsx)(n,{path:`/status.character/*?`,children:(0,Y.jsx)(Ge,{})}),(0,Y.jsx)(n,{path:`/missions.character/*?`,children:(0,Y.jsx)(Ve,{})})]}),(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(n,{path:`/overview.world/*?`,children:(0,Y.jsx)(Re,{})}),(0,Y.jsx)(n,{path:`/statistics.world/*?`,children:(0,Y.jsx)(ze,{})}),(0,Y.jsx)(n,{path:`/config.world/*?`,children:(0,Y.jsx)(Ke,{})}),(0,Y.jsx)(n,{path:`/debug.world/*?`,children:(0,Y.jsx)(tt,{})})]}),O.hooks.useDefaultRoutes(r)]})]})}function ut({children:e}){let t=dt();return W(`span`,{id:`grider`,css:[t.base,t.scrollbarStyle],children:e})}function dt(){return{base:u`
		...
		`}}var ft={duration:300,snappingDown:!0};function pt(){let e=(0,G.useRef)(null),t=O.hooks.useSmoothRef(()=>{let e=I.progress.getSingletonProgressing();return e?j(U(e.general.id).categoryId).user.level%1:0},ft);return O.hooks.useUpdate(()=>{let n=e.current;if(!n)return;let r=I.progress.getSingletonProgressing(),i=L.primitive.clamp(t.current,0,1);n.style.setProperty(`--header-percentage`,`${i*100}%`),n.style.setProperty(`--header-color`,r?O.style.geFadedColor(U(r.general.id).information.color):`transparent`)}),W(`div`,{css:mt(),ref:e})}function mt(){return u`
		position: fixed;
		...
		z-index: 20;
	`}var ht={},gt={duration:300};function _t(){let[e,t]=(0,G.useState)(()=>O.scroll.getScrolledPosition().x>0),[n,i]=(0,G.useState)(()=>I.progress.getSingletonProgressing()?.general.id),a=(0,G.useRef)(null),[,o]=O.hooks.useLocation(),s=()=>{O.scroll.slideTop()},c=()=>{let e=O.component.getSingletonProgressingPath();e&&(o(e),O.scroll.slideBottom())},u=O.hooks.useSmoothRef(()=>{let e=I.progress.getSingletonProgressing();return e?I.progress.caluculateBarProgresing(e):0},()=>I.progress.getSingletonProgressing()?.combat?gt:ht);return O.hooks.useUpdate(()=>{i(I.progress.getSingletonProgressing()?.general.id),t(O.scroll.getScrolledPosition().x>0);let e=a.current;e&&(e.style.transform=`scaleX(${L.primitive.clamp(u.current,0,1)})`)}),r(`span`,{css:[vt(8).base],children:[W(l,{height:8,fillRef:a,color:n?O.style.getActionProgressColor(n):void 0}),e&&W(b,{id:`go-top`,leftern:!0,handler:s,size:26}),n&&W(b,{id:n,leftern:!1,handler:c,size:26})]})}function vt(e){return{base:u`
			/* display: flex; */
			position: relative;
			width: 100svw;
			height: ${e}px;
		...
		`}}var yt,bt,xt=2/3,St=.15;function Ct(){let[e]=O.hooks.useLocation();return yt?null:(O.component.setBackgroundHandler(wt),wt(Tt(e)),null)}function wt(t){if(Et(yt,t))return;yt=t;let n=(t==`world`?``:j(t[1]).world.background)||N.basic.design.background||``;if(bt===n)return;bt=n;let r=e.colors.background,{h:i,s:a,l:o}=M(r).hsl().object(),s=Dt(i*(1-St),a*(1-St),o*(1-St)),c=Dt(i*1.15,a*1.15,o*1.15),l=e=>`linear-gradient(
		to top,
		${M(s).alpha(e).rgb().string()},
		${M(r).alpha(e).rgb().string()},
		${M(c).alpha(e).rgb().string()}
	)`;window.document.body.style.background=n?`${l(xt)}, url(${n}) center / cover no-repeat fixed`:l(1),window.document.body.style.backgroundColor=e.colors.bar}function Tt(e){let t=e.split(`/`).reverse();for(let e of t){let[t,n]=e.split(`.`);if(!(!t||!n)){if(n==`category`)return[`category`,t];if(n==`action`)return[`category`,U(t).categoryId];if(n==`item`){let e=w(t).categoryId;return e?[`category`,e]:`world`}}}return`world`}function Et(e,t){return e?e==`world`?t==`world`:t==`world`?!1:e[1]==t[1]:!1}function Dt(e,t,n){return`hsl(${e}, ${t}%, ${n}%)`}function Ot(){let[e,t]=(0,G.useState)(!1),n=(0,G.useRef)(!1);(0,G.useEffect)(()=>{(async()=>{if(!n.current){n.current=!0;try{await ne(),be(),re(),I.event.check(),t(!0)}catch(e){console.error(`Initialization error:`,e)}}})()},[]);let[i,a]=O.hooks.useLocation();(0,G.useEffect)(()=>{if(!e)return;let t=me(i);t&&a(t)},[e,i,a]),(0,G.useEffect)(()=>{e&&(_e(),ie())},[e]);let o=()=>{if(R.check.debugMode())return{background:`linear-gradient(135deg, #667eea 0%, #764ba2 100%)`,color:`white`};let e=document.querySelector(`meta[name="bar-color"]`),t=document.querySelector(`meta[name="text-color"]`);return{background:e?.content||`#667eea`,color:t?.content||`white`}};if(!e){let e=o();return r(`div`,{css:sn(e.background,e.color),children:[W(Le,{color:e.color,size:80,cssOverride:{display:`block`}}),W(`h2`,{children:`Loading Game...`}),W(`p`,{children:`Initializing world data and assets`})]})}return W(ye,{children:W(kt,{})})}function kt(){return pe(),r(S,{children:[W(`div`,{style:{display:de?`block`:`none`},children:`This game was interrupted because it was opened in another tab.`}),r(`div`,{style:{display:de?`none`:`block`},children:[W(x,{styles:an}),W(ue,{base:`/`,hook:ke,children:r(`div`,{css:on,children:[W(pt,{}),W(ut,{children:W(lt,{})}),W(_t,{})]})}),W(At,{}),W(fe,{}),W(Ct,{})]})]})}function At(){let{toasts:e,handlers:t}=te(Yt),n=new Map(jt.map(e=>[e,[]]));for(let t of e)n.get(t.position||It).push(t);let r=n.get(`bottom-left`).length>0||n.get(`bottom-right`).length>0;return W(`div`,{className:Ft,style:Lt,children:[...n].filter(([,e])=>e.length>0).map(([e,n])=>W(`div`,{style:Ht(e,r&&e==`bottom-center`),children:Mt(e,n).map(n=>W(Nt,{item:n,position:e,onHeightUpdate:t.updateHeight},n.id))},e))})}var jt=[`top-left`,`top-center`,`top-right`,`bottom-left`,`bottom-center`,`bottom-right`];function Mt(e,t){if(e.startsWith(`top`))return t;let n=[...t].reverse();if(e!=`bottom-left`&&e!=`bottom-right`)return n;let r=e=>e.className==O.toaster.cornerPopClassName?0:1;return n.sort((e,t)=>r(e)-r(t))}function Nt({item:e,position:t,onHeightUpdate:n}){return W(`div`,{ref:(0,G.useCallback)(t=>{t&&n(e.id,t.getBoundingClientRect().height)},[e.id,n]),style:e.className==O.toaster.inlineClassName?zt:Bt(t),children:W(d,{toast:e,style:nn(e)})})}var Z={fontSize:`12px`,padding:`5px 7px`},Pt=5,Ft=`playerToaster`,It=`top-center`,Q=16,Lt={position:`fixed`,zIndex:9999,top:Q,left:Q,right:Q,bottom:Q,pointerEvents:`none`},Rt=100,zt={display:`flex`};function Bt(e){return{display:`flex`,flexBasis:`100%`,justifyContent:Vt(e)}}function Vt(e){return e.endsWith(`left`)?`flex-start`:e.endsWith(`right`)?`flex-end`:`center`}function Ht(e,t){return{position:`absolute`,left:0,right:0,...e.startsWith(`top`)?{top:0}:{bottom:0},display:`flex`,flexFlow:`row wrap`,alignItems:`center`,justifyContent:Vt(e),gap:`${Pt}px`,...t?{paddingLeft:`${Rt}px`,paddingRight:`${Rt}px`}:{}}}var Ut=`playerToastFadeIn`,Wt=`playerToastFadeOut`,Gt=`playerToastPopInTop`,Kt=`playerToastPopInBottom`,qt=`playerToastPopOutBottom`,Jt=300,$=`${Jt}ms`,Yt={removeDelay:Jt},Xt=3e3,Zt={...Z,pointerEvents:`auto`,animation:`${Ut} ${$} ease-in-out forwards`},Qt={...Z,pointerEvents:`none`,animation:`${Wt} ${$} ease-in-out forwards`},$t={...Z,pointerEvents:`auto`,animation:`${Gt} ${$} ease-in-out forwards`},en={...Z,pointerEvents:`auto`,animation:`${Kt} ${$} ease-in-out forwards`},tn={...Z,pointerEvents:`none`,animation:`${qt} ${$} ease-in-out forwards`};function nn(e){let t=rn(e);return e.position==`bottom-left`||e.position==`bottom-right`?{...t,pointerEvents:`none`}:t}function rn(e){return e.position==`bottom-left`||e.position==`bottom-right`?e.visible?en:tn:e.visible?(e.duration??0)<Xt?Zt:(e.position??`top-center`).startsWith(`top`)?$t:en:Qt}var an=u`
	...
	.${Ft} > div > div > div > div:last-child {
		margin: 3px 7px;
	}

	/* 本文以外の子＝showResult の成功/失敗アイコン。ライブラリ内で 20px 固定なので、
	   他のアイコンに合わせて縮小する */
	.${Ft} > div > div > div > div:not(:last-child) {
...
`;console.log(`🎮 Player Build Version: 0.0.1673`),console.log(`📅 Player Build Date: ${new Date(`2026-08-20T12:22:31.620Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Ot,{})}));