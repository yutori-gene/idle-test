...
`;console.log(`🎮 Player Build Version: 0.0.1630`),console.log(`📅 Player Build Date: ${new Date(`2026-08-14T07:24:03.745Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));