...
`;console.log(`🎮 Player Build Version: 0.0.1648`),console.log(`📅 Player Build Date: ${new Date(`2026-08-15T06:10:14.447Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));