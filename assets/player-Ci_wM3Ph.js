...
`;console.log(`🎮 Player Build Version: 0.0.1609`),console.log(`📅 Player Build Date: ${new Date(`2026-08-13T11:50:17.946Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));