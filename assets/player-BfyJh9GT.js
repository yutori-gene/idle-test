...
`;console.log(`🎮 Player Build Version: 0.0.1592`),console.log(`📅 Player Build Date: ${new Date(`2026-08-12T15:15:47.756Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));