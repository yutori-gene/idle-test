...
`;console.log(`🎮 Player Build Version: 0.0.1676`),console.log(`📅 Player Build Date: ${new Date(`2026-08-22T01:51:19.503Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Ot,{})}));