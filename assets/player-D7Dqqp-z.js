...
`;console.log(`🎮 Player Build Version: 0.0.1666`),console.log(`📅 Player Build Date: ${new Date(`2026-08-16T10:15:12.017Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Et,{})}));