...
`;console.log(`🎮 Player Build Version: 0.0.1729`),console.log(`📅 Player Build Date: ${new Date(`2026-08-27T05:31:45.866Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(At,{})}));