...
`;console.log(`🎮 Player Build Version: 0.0.1517`),console.log(`📅 Player Build Date: ${new Date(`2026-08-03T23:31:37.478Z`).toLocaleString(`ja-JP`)}`),ve.createRoot(document.getElementById(`root`)).render((0,Z.jsx)(K.StrictMode,{children:(0,Z.jsx)(ft,{})}));