...
`;console.log(`🎮 Player Build Version: 0.0.1735`),console.log(`📅 Player Build Date: ${new Date(`2026-08-27T10:21:01.349Z`).toLocaleString(`ja-JP`)}`),Ee.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(Mt,{})}));