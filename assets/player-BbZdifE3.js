...
`;console.log(`🎮 Player Build Version: 0.0.1717`),console.log(`📅 Player Build Date: ${new Date(`2026-08-24T00:18:54.029Z`).toLocaleString(`ja-JP`)}`),we.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(G.StrictMode,{children:(0,Y.jsx)(At,{})}));