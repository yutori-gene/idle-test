...
`;console.log(`🎮 Player Build Version: 0.0.1576`),console.log(`📅 Player Build Date: ${new Date(`2026-08-11T23:18:25.720Z`).toLocaleString(`ja-JP`)}`),xe.createRoot(document.getElementById(`root`)).render((0,X.jsx)(G.StrictMode,{children:(0,X.jsx)(xt,{})}));